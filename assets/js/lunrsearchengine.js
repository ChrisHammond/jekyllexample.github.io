...
var documents = [{
    ...
    "title": "Home",
    "body": "  Welcome to JekyllExample. com      A sample website built on the Jekyll platform designed to make it easy for you to get a website of your own up and running.         Featured:                                                                                                                                                                                                             Structured Content in Jekyll                              :               Introduction In the ever-evolving world of SEO and web development, structured content has become a cornerstone for creating high-performing, search-engine-friendly websites. For those who use. . . :                                                                                                                                                                                         Chris Hammond                                                  21 Jun 2024                                                                                                                                                                                                                                                                                                                    Installing Jekyll locally on Ubuntu and getting it running using Windows Hyper-V                              :               This post is still a work in progress as of 05/17/2024 Create a new Hyper-V VM installing Ubuntu 22. 04 Run updates for Ubuntu (reboot if. . . :                                                                                                                                                                                         Chris Hammond                                                  18 Apr 2024                                                                                                                                                                                                                                                                                                                    Example Jekyll Sites based on this Repository                              :               This blog post will be an ongoing list with some examples of websites that have been built based on this template/sample/repository! If you have a. . . :                                                                                                                                                                                         Chris Hammond                                                  01 Feb 2023                                                                                                                                                                                                                                                                                                                    Easy instructions for installing Jekyll                              :               This post is still a work in progress as of 5/18/2024 The goal for this blog post is to provide easy instructions for installing Jekyll. . . . :                                                                                                                                                                                         Chris Hammond                                                  01 Feb 2023                                                                                                                                                                                                                                                                                                                    Getting started with Jekyll                              :               So you want to get started with Jekyll? Well, you’ve come to the right place. This post will walk you through the steps to get. . . :                                                                                                                                                                                         Chris Hammond                                                  31 Jan 2023                                                                                                                                                                                                                                                                                                                          First Blog Post                              :               This is the first blog post using JekyllExample. com. This is a quote inside that first blog post This is a list item This is a. . . :                                                                                                                                                                                         Chris Hammond                                                  10 Jul 2022                                                                                                                      All Stories:                                                                               Structured Content in Jekyll              :       Introduction In the ever-evolving world of SEO and web development, structured content has become a cornerstone for creating high-performing, search-engine-friendly websites. For those who use static site generators like Jekyll,. . . :                                                                                               Chris Hammond                          21 Jun 2024                                                                                                              Installing Jekyll locally on Ubuntu and getting it running using Windows Hyper-V              :       This post is still a work in progress as of 05/17/2024 Create a new Hyper-V VM installing Ubuntu 22. 04 Run updates for Ubuntu (reboot if necessary) Install GIT sudo apt. . . :                                                                                               Chris Hammond                          18 Apr 2024                                                                                            Example Jekyll Sites based on this Repository              :       This blog post will be an ongoing list with some examples of websites that have been built based on this template/sample/repository! If you have a site built on this template. . . :                                                                                               Chris Hammond                          01 Feb 2023                                                                                                              Easy instructions for installing Jekyll              :       This post is still a work in progress as of 5/18/2024 The goal for this blog post is to provide easy instructions for installing Jekyll. If you follow these steps,. . . :                                                                                               Chris Hammond                          01 Feb 2023                                                                                                              Getting started with Jekyll              :       So you want to get started with Jekyll? Well, you’ve come to the right place. This post will walk you through the steps to get you going if you’re new. . . :                                                                                               Chris Hammond                          31 Jan 2023                                                                                                              Non-featured Blog Post              :       This is the second blog post, the difference is that this one is not featured. This is a quote inside that first blog post This is a list item This. . . :                                                                                               Chris Hammond                          01 Nov 2022                                                                                                              First Blog Post              :       This is the first blog post using JekyllExample. com. This is a quote inside that first blog post This is a list item This is a nested list item This is. . . :                                                                                               Chris Hammond                          10 Jul 2022                                            "
    }, {
    "id": 3,
    "url": "https://www.jekyllexample.com/About",
    "title": "",
    ...
    "id": 5,
    "url": "https://www.jekyllexample.com/categories.html",
    "title": "",
    "body": ""
    }, {
    "id": 6,
    ...
    "title": "",
    "body": "{“/About”:”https://www. jekyllexample. com/about”,”/categories”:”https://www. jekyllexample. com/category”,”/categories. html”:”https://www. jekyllexample. com/category”,”/tags”:”https://www. jekyllexample. com/category”} "
    }, {
    "id": 7,
    ...
    "id": 8,
    "url": "https://www.jekyllexample.com/structured-content-in-jekyll",
    "title": "Structured Content in Jekyll",
    "body": "2024/06/21 - Introduction: In the ever-evolving world of SEO and web development, structured content has become a cornerstone for creating high-performing, search-engine-friendly websites. For those who use static site generators like Jekyll, leveraging structured content can significantly enhance your site’s visibility and usability. In this blog post, we’ll explore the benefits of using structured content with Jekyll, specifically focusing on the JekyllExample. com template/repo. What is Structured Content?: Structured content is a way of organizing information on your website so that it is easily understood by search engines and other web services. This is often achieved using schema markup (or structured data), which provides context to your content, making it more accessible and indexable. Common types of structured data include information about articles, events, products, and reviews, among others. Benefits of Structured Content: Improved SEO: One of the primary benefits of structured content is its impact on SEO. By adding schema markup to your Jekyll site, you provide search engines with detailed information about your content. This can result in better indexing and higher rankings, as search engines can more accurately understand and present your content to users. Enhanced Rich Snippets: Structured data can enhance the appearance of your site in search results by generating rich snippets. These are enhanced listings that show additional information, such as ratings, authors, and dates, directly in the search results. Rich snippets can improve your click-through rates by making your listings more attractive and informative. Better Content Organization: Using structured content helps you maintain a consistent and organized format for your information. This is particularly useful for larger websites with diverse content types. It ensures that each piece of content follows a set structure, making it easier to manage and update. Improved Accessibility: Structured content can also improve the accessibility of your site. By providing clear, well-defined data structures, you make it easier for assistive technologies, like screen readers, to interpret and present your content to users with disabilities. Using the JekyllExample. com Template: The JekyllExample. com template/repo is an excellent starting point for those looking to implement structured content on a Jekyll-based website. This template comes with built-in support for structured data, specifically using the BlogPosting schema type. If your site requires a different content type, such as Article, you can easily modify the schema type to fit your needs. Conclusion: Integrating structured content into your Jekyll site using the JekyllExample. com template can significantly enhance your site’s SEO, user experience, and accessibility. By providing clear, organized data to search engines and assistive technologies, you make your content more discoverable and user-friendly. Start leveraging the power of structured content today and watch your Jekyll site soar in the search rankings. "
    }, {
    "id": 9,
    "url": "https://www.jekyllexample.com/jekyll-on-ubuntu",
    "title": "Installing Jekyll locally on Ubuntu and getting it running using Windows Hyper-V",
    "body": "2024/04/18 - This post is still a work in progress as of 05/17/2024:  Create a new Hyper-V VM installing Ubuntu 22. 04 Run updates for Ubuntu (reboot if necessary) Install GIT     sudo apt install git     Install Bundler     sudo apt install bundler     Install RBEnv to allow for multiple versions of Ruby Install Jekyll GEM Install other required libraries     sudo apt install libvips-tools     Create a projects directory via a terminal:     mkdir projects     Navigate into the project directory:     cd projects     Clone the JekyllExample repository, from a Terminal in Ubunty type     git clone https://github. com/ChrisHammond/jekyllexample. github. io. git     Navigate into the new directory     cd jekyllexample. github. io     Run the following terminal command to get everything installed properly     bundle install     Run Jekyll to start a local webserver     bundle exec jekyll serve     Browse to http://127. 0. 0. 1:4000 in your web browserNext steps::  If you have a large repository, or a large number of repositories, you might run out of disk space on your Hyper-V VM, if that’s the case check out this tutorial for how to expand your Ubuntu disk.  Install Homebrew and Git Credential Manager     /bin/bash -c “$(curl -fsSL https://raw. githubusercontent. com/Homebrew/install/HEAD/install. sh)”     brew tap microsoft/gitbrew install –cask git-credential-manager-core "
    }, {
    "id": 10,
    ...
    "body": "2022/07/10 - This is the first blog post using JekyllExample. com.  This is a quote inside that first blog post  This is a list item     This is a nested list item    This is a second list item     This is a nested list item         This is a nested-nested list item          Header 1Some text under header 1 Header 2: Some text under header 2 Header 3: Some text under header 3 This is a link This template is from Chris Hammond "
    }];
